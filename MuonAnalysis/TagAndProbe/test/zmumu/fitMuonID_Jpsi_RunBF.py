...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("TnP_Muon_ID_RunBF_Jpsi_tag_Mu7p5_Track2_tagPtgt9p0.root"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_RunBF_Jpsi_tag_Mu7p5_Track2_tagPtgt9p0.root"),
    ## More variables
