...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring("file:../../../SkimTrees/skimmedTree_Jpsi_RunB_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
				 "file:../../../SkimTrees/skimmedTree_Jpsi_RunC_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
				 "file:../../../SkimTrees/skimmedTree_Jpsi_RunD_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
                                 "file:../../../SkimTrees/skimmedTree_Jpsi_RunE_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
                                 "file:../../../SkimTrees/skimmedTree_Jpsi_RunF_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
                                 "file:../../../SkimTrees/skimmedTree_Jpsi_RunG_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
    ...
    OutputFileName = cms.string("TnP_Muon_ID_RunAll_Jpsi_tag_Mu7p5_Track2_tagPtgt9p0.root"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_RunAll_Jpsi_tag_Mu7p5_Track2_tagPtgt9p0.root"),
    ## More variables
