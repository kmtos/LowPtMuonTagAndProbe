...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring("file:../../../SkimTrees/skimmedTree_Jpsi_MC_tag_Mu7p5_Track2_Jpsi_tagPtgt9p0.root",
                                 ), 
    OutputFileName = cms.string("TnP_Muon_ID_MC_Jpsi_tag_Mu7p5_Track2_tagPtgt9p0.root"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_MC_Jpsi_tag_Mu7p5_Track2_tagPtgt9p0.root"),
    ## More variables
