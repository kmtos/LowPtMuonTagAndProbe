...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring("file:../../../SkimTrees/skimmedTree_Jpsi_RunB_IsoMu20_tagPtgt21p0.root", 
				 "file:../../../SkimTrees/skimmedTree_Jpsi_RunC_IsoMu20_tagPtgt21p0.root", 
				 "file:../../../SkimTrees/skimmedTree_Jpsi_RunD_IsoMu20_tagPtgt21p0.root",
                                 ), 
    OutputFileName = cms.string("TnP_Muon_ID_RunBCD_Jpsi_IsoMu20.root"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_RunBCD_Jpsi_IsoMu20.root"),
    ## More variables
