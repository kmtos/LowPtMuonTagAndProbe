...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring("file:../../../SkimTrees/skimmedTree_DY_RunE_IsoMu24_tagPtgt25p0.root", 
				 "file:../../../SkimTrees/skimmedTree_DY_RunF_IsoMu24_tagPtgt25p0.root", 
                                 ), 
    OutputFileName = cms.string("TnP_Muon_ID_RunEF_DY_IsoMu24_pt.root"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_RunEF_DY_IsoMu24_pt.root"),
    ## More variables
