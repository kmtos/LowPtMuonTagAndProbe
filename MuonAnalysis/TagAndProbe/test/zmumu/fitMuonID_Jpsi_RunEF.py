...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring("file:../../../SkimTrees/skimmedTree_Jpsi_RunE_IsoMu24_tagPtgt25p0.root", 
				 "file:../../../SkimTrees/skimmedTree_Jpsi_RunF_IsoMu24_tagPtgt25p0.root", 
                                 ),
    ## and then set InputFileNames = cms.vstring("tnpZ_Data.190456-193557.root"), 
    OutputFileName = cms.string("TnP_Muon_ID_RunEF_Jpsi_IsoMu24.root"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_RunEF_Jpsi_IsoMu24.root"),
    ## More variables
