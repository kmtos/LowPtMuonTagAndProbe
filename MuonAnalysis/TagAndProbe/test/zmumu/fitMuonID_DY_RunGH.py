...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ## Input, output 
    InputFileNames = cms.vstring("file:../../../SkimTrees/skimmedTree_DY_MTight_RunG_IsoMu24_tagPtgt26p0_70to110_PART2.root",
#                                 "file:../../../SkimTrees/skimmedTree_DY_MTight_RunH2_IsoMu24_tagPtgt26p0_70to110_PART2.root",
    ...
    OutputFileName = cms.string("TnP_Muon_ID_RunGH_DY_IsoMu24_pt26_70to110_PART2.root"),
    InputTreeName = cms.string("fitter_tree"), 
    InputDirectoryName = cms.string("tpTree"),  
    ## Variables for binning
    Variables = cms.PSet(
        mass   = cms.vstring("Tag-muon Mass", "70", "110", "GeV/c^{2}"),
        pt     = cms.vstring("muon p_{T}", "0", "110", "GeV/c"),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("TnP_Muon_Iso_RunGH_DY_IsoMu24_pt26_70to110.root"),
    ## More variables
